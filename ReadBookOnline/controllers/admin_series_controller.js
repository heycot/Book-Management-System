...
module.exports = function(app){
	app.get('/admin/series', function(req, res){
		var msg = "";
		var st = "";
		...
		series_dao.getListSeries(function(results){
			if( results !== undefined && results.length !== "" ){
				res.render('pages/admin/series/index', {listSeries: results, msg: msg, st: st});
            }else{
                res.render('pages/admin/series/index', {msg: msg, st: st});
            }

		});
	})

	app.get('/admin/series/add', function(req, res){
		res.render("pages/admin/series/add");
	})

	app.get('/admin/series/edit', function(req, res){
		if(req.param('id') !== undefined ){
			var id = req.param('id');
			series_dao.getSeries(id, function(series){
				if(series.getMId() !== null){
					res.render('pages/admin/series/edit', {series: series});
				}else{
    ...
    app.get('/admin/series/delete', function(req, res){
		if( req.param('id') !== undefined){
            var id =  req.param('id');
	...
	app.post('/admin/series/add', function(req, res){
        ...
        if(nameSeries == "" || summary == ""){
            res.render('pages/admin/series/add', {series: series, msg: "errnull"});
        }else if( nameSeries.length > 50){
            res.render('pages/admin/series/add', {series: series, msg: "errnamelength"});
        }else if( summary.length > 1000){
            res.render('pages/admin/series/add', {series: series, msg: "errsummarylength"});
        }else{
            series_dao.getSeriesByName(nameSeries, function(result){
                if(result > 0){
                    res.render('pages/admin/series/add', {series: series, msg: "errexists"});
                }else{
	                series_dao.addSeries(series, function(result){
	                    ...
	                    if(result.affectedRows > 0){
	                        ...
	                        res.render('pages/admin/series/add', {series: series, msg: "erradd"});
	                    }
	                });
                }
            });
    ...
    app.post('/admin/series/edit', function(req, res){
        if(req.param('id') !== undefined ){
            var id = req.param('id');
            ...
            if(name == "" || summary == ""){
                res.render('pages/admin/series/edit', {series: series, msg: "errnull"});
            }else {
	                ...
	                if(result > 0){
						...
						series_dao.editSeries(series, function(result){
		                    if(result.affectedRows > 0){
		                        ...
		                        res.render('pages/admin/series/add', {series: series, msg: "erredit"});
		                    }
		                });
	                }
	            });
    ...
    app.post('/admin/series/delete', function(req, res){
